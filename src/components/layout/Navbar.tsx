              ...
              {isProfileMenuOpen && (
                <div className="absolute right-0 mt-2 w-56 py-2 bg-white dark:bg-[#0B1120] rounded-xl shadow-2xl border border-slate-200 dark:border-slate-800 z-50">
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2 text-xs font-medium text-rose-500 hover:bg-rose-500/10 flex items-center gap-2 transition-colors"
                  >
        ...
        <div className="md:hidden border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-[#080D18] px-4 pt-3 pb-5 space-y-2">
          ...
          <div className="pt-2 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between px-3 py-2">
            <span className="flex items-center gap-2 text-xs font-semibold text-slate-700 dark:text-slate-300">
              {theme === 'dark' ? <Moon className="w-4 h-4 text-indigo-500 dark:text-cyan-400" /> : <Sun className="w-4 h-4 text-amber-500" />}
              <span>{theme === 'dark' ? 'Dark Mode' : 'Light Mode'}</span>
            </span>
            <button
              onClick={toggleTheme}
              className="px-3 py-1 rounded-lg text-xs font-medium bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
            >
